<div align="center">
  ...
  <p>
    <img alt="Views" src="https://komarev.com/ghpvc/?username=johncarvalhonx&style=for-the-badge&color=39D353">
    <img alt="Followers" src="https://img.shields.io/github/followers/johncarvalhonx?style=for-the-badge">
    <img alt="Last Update" src="https://img.shields.io/github/last-commit/johncarvalhonx/johncarvalhonx?style=for-the-badge&label=%C3%BAltimo%20commit">
  </p>
...
Atuação com **backend, APIs e integrações**, buscando **serviços estáveis**, **código bem mantido** e **entrega consistente**. No contexto de sistemas corporativos (ex.: **Salesforce/SOLAR**), também atuo com **observabilidade** (logs, métricas e alertas) e resolução de problemas quando necessário.

---

## ⚡ Destaques

- **Backend com Python**: APIs REST, autenticação **OAuth2/JWT**, camadas com **SQLAlchemy**, concorrência/assíncrono quando faz sentido.
- **Integrações**: consumo/exposição de APIs e integração com ferramentas de fluxo (ex.: **JIRA**), com atenção a contratos e consistência.
- **Qualidade e entrega**: **Pytest**, **CI/CD (GitHub Actions)**, versionamento e revisões via **Git/GitHub**.
- **Dados**: modelagem e consultas em **MySQL** e **MongoDB**.
- **Base web**: familiaridade com **JavaScript/TypeScript**, **HTML/CSS** e **React** para apoiar quando o assunto encosta no front.
...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=python,java,fastapi,spring,git,github,githubactions,docker,linux,mysql,mongodb,js,ts,react,html,css,vscode,postman&perline=10" alt="skills" />
  </a>
</p>
...
**Analista de Sistemas Pleno — Claro Brasil | [10/2025] — atual**
- Atuação em **backend, APIs e integrações** no contexto de **[Salesforce/SOLAR]**.
- Sustentação/evolução de serviços, troubleshooting e melhorias de **observabilidade** (logs, métricas e alertas).

**Dev Backend (Freelancer) | [01/2023] — atual**
- APIs e ferramentas em Python, integrações com serviços externos e entregas versionadas.

**Experiências anteriores**
- **Analista de Sistemas — Polícia Civil (DIPOL/DTI) | [08/2025] — [10/2025]**
- **Digitador — PRODESP | [05/2024] — [07/2025]**
